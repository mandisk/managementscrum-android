...
public class EditProjectActivity extends android.app.ExpandableListActivity {
	...
	private List<UserDetail> userListinProject;
	...
	public void onCreate(Bundle savedInstanceState) {
     ...
     //Lista de usuarios
    		 ...
    		 String json2 = getIntent().getExtras().getString("userinproject");
    		 userListinProject = JSONConverter.fromJSONtoUserList(json2);
...
//    	  /* each group need each HashMap-Here for each group we have 3 subgroups */
    	  ...
    	  for (UserDetail user : userListinProject) {
    	   ...
    	   userListAll.addAll(userListinProject);
